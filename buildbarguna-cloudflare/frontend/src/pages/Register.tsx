    ...
    <div className="min-h-screen bg-gradient-to-br from-primary-900 via-primary-800 to-teal-700 flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="bg-white rounded-3xl shadow-2xl w-full max-w-md p-8 relative z-10">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <label className="label" htmlFor="name"><User size={16} className="inline-block mr-1" /> পূর্ণ নাম</label>
            <input id="name" className="input" type="text" placeholder="আপনার নাম" value={form.name}
              onChange={e => setForm(p => ({ ...p, name: e.target.value }))} required />
          </div>
          <div>
            <label className="label" htmlFor="email"><Mail size={16} className="inline-block mr-1" /> ইমেইল ঠিকানা <span className="text-red-500">*</span></label>
            <input id="email" className="input" type="email" placeholder="আপনার ইমেইল দিন" value={form.email}
              onChange={e => setForm(p => ({ ...p, email: e.target.value }))} required />
          </div>
          <div>
            <label className="label" htmlFor="phone"><Phone size={16} className="inline-block mr-1" /> মোবাইল নম্বর <span className="text-gray-400 font-normal text-xs">(ঐচ্ছিক)</span></label>
          ...
          <div>
            <label className="label" htmlFor="password"><Lock size={16} className="inline-block mr-1" /> পাসওয়ার্ড</label>
          ...
          <div>
            <label className="label" htmlFor="referral_code"><Gift size={16} className="inline-block mr-1" /> রেফারেল কোড <span className="text-gray-400 font-normal text-xs">(ঐচ্ছিক)</span></label>
            <div className="relative">
              <input
                id="referral_code"
