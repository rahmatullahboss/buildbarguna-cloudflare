    ...
    <div className="space-y-6">
        ...
        <div className="relative z-10 flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-emerald-100 text-sm mt-0.5">
              রেফারেল বোনাস সেটিং ও নেটওয়ার্ক পরিসংখ্যান
            </p>
          </div>
        </div>
      </div>
      ...
      {msg && (
        <div className="flex items-center gap-2 bg-green-50 border border-green-200 text-green-700 rounded-lg p-3 text-sm">
          ...
          <button
            onClick={() => setMsg("")}
            className="ml-auto text-green-500 hover:text-green-700 p-1 hover:bg-green-100/50 rounded-full transition-colors"
      ...
      {errMsg && (
        <div className="flex items-center gap-2 bg-red-50 border border-red-200 text-red-700 rounded-lg p-3 text-sm">
          ...
          <button
            onClick={() => setErrMsg("")}
            className="ml-auto text-red-400 hover:text-red-600 p-1 hover:bg-red-100/50 rounded-full transition-colors"
        ...
        <div className="card text-center">
          ...
          {statsLoading ? (
            ...
            <p className="text-2xl font-bold text-amber-600">
              {formatTaka(stats?.total_bonus_paid_paisa ?? 0)}
            </p>
          )}
          ...
          <div className="space-y-3">
            <div>
              ...
              <p className="text-xs text-gray-400 mb-1">
                ১০০ পয়সা = ৳১ — সর্বোচ্চ ১,০০,০০০ পয়সা (৳১,০০০)
              </p>
          ...
          <div className="bg-gray-50 rounded-xl p-4 flex items-center justify-between">
            <div>
              <p className="text-sm text-gray-500">
                প্রতি রেফারেলে বোনাস (প্রথম বিনিয়োগে)
              </p>
                  ...
                  >
                    ...
                    <td className="py-3 px-4 text-right">
                      <span className="font-bold text-amber-600">
                        {formatTaka(r.total_earned_paisa)}
                      </span>
                    </td>
                  </tr>
                ))}
