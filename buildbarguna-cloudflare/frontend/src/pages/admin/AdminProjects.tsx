        ...
        <div className="card border-primary-200 bg-primary-50">
          <div className="flex items-center justify-between mb-4">
            ...
            <button
              ...
              className="text-gray-400 hover:text-gray-600 focus-visible:ring-2 focus-visible:outline-none focus-visible:ring-primary-500 rounded-md p-1"
            >
              <X size={20} />
            </button>
          </div>
                      ...
                      <div key={u.id} className="bg-white border border-gray-100 rounded-xl p-3">
                        <div className="flex items-start justify-between gap-2">
                          ...
                          <button
                            ...
                            title="আপডেট মুছুন"
                            className="text-red-400 hover:text-red-600 shrink-0 focus-visible:ring-2 focus-visible:outline-none focus-visible:ring-red-500 rounded-md p-1"
                          >
                            <Trash2 size={14} />
                          </button>
                        </div>
