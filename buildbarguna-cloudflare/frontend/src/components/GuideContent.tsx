        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <button
              ...
              className="lg:hidden p-2 rounded-lg hover:bg-gray-100 focus-visible:ring-2 focus-visible:outline-none focus-visible:ring-blue-500"
              aria-label={showMobileMenu ? 'মেনু বন্ধ করুন' : 'মেনু খুলুন'}
              aria-expanded={showMobileMenu}
            >
              {showMobileMenu ? <X className="w-5 h-5 text-gray-600" /> : <Book className="w-5 h-5 text-gray-600" />}
            </button>
          </div>
        </div>
      </div>
              ...
              <div className="absolute left-0 top-0 h-full w-72 bg-white shadow-xl" onClick={e => e.stopPropagation()}>
                <div className="p-4 border-b flex items-center justify-between">
                  ...
                  <button
                    ...
                    className="p-2 hover:bg-gray-100 rounded-lg focus-visible:ring-2 focus-visible:outline-none focus-visible:ring-blue-500"
