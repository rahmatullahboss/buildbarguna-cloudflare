        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <button
              ...
              className="lg:hidden p-2 rounded-lg hover:bg-gray-100" aria-label={showMobileMenu ? "মেনু বন্ধ করুন" : "মেনু খুলুন"}
            >
            ...
            <div className="lg:hidden fixed inset-0 z-50 bg-black bg-opacity-50" onClick={() => setShowMobileMenu(false)}>
              <div className="absolute left-0 top-0 h-full w-72 bg-white shadow-xl" onClick={e => e.stopPropagation()}>
                <div className="p-4 border-b flex items-center justify-between">
                  <h2 className="font-semibold text-gray-900">সূচিপত্র</h2>
                  <button onClick={() => setShowMobileMenu(false)} className="p-2 hover:bg-gray-100 rounded-lg" aria-label="বন্ধ করুন">
                    <X className="w-5 h-5" />
                  </button>
                </div>
