        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <button
              ...
              className="lg:hidden p-2 rounded-lg hover:bg-gray-100 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary-500"
            ...
            >
              ...
              >
                <div className="p-4 border-b flex items-center justify-between">
                  ...
                  <button
                    onClick={() => setShowMobileMenu(false)}
                    className="p-2 hover:bg-gray-100 rounded-lg focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary-500"
                    aria-label="মোবাইল মেনু বন্ধ করুন"
                    title="মোবাইল মেনু বন্ধ করুন"
                  >
                    <X className="w-5 h-5" />
                  </button>
                </div>
                    ...
                    <ReactMarkdown
                      ...
                      components={{
                        ...
                        code: ({ node, inline, ...props }: any) =>
                          inline ? (
                            <code
                              className="px-2 py-1 bg-gray-100 rounded text-sm font-mono text-pink-600"
                              {...props}
                            />
                          ) : (
                            <code
                              className="block p-4 bg-gray-900 rounded-lg text-green-400 font-mono text-sm overflow-x-auto"
                              {...props}
                            />
                          ),
                        ...
                        th: ({ node, ...props }) => (
                          <th
                            className="px-4 py-2 bg-gray-50 border-b font-semibold text-left"
                            {...props}
                          />
                        ),
                        td: ({ node, ...props }) => (
