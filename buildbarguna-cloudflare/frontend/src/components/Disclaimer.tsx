...
const disclaimers: Record<DisclaimerVariant, {
  ...
  halal: {
    icon: <Shield size={18} />,
    title: '✅ সম্পূর্ণ হালাল বিনিয়োগ',
    color: 'bg-emerald-50',
    borderColor: 'border-emerald-200',
    iconColor: 'text-emerald-600',
    points: [
      'এই প্ল্যাটফর্মে সকল বিনিয়োগ সম্পূর্ণ ইসলামিক শরিয়াহ নীতি অনুযায়ী পরিচালিত হয়।',
      'প্রজেক্টের লাভ হলে শেয়ার অনুপাতে লাভ বণ্টন হবে — কোনো নির্দিষ্ট (গ্যারান্টিযুক্ত) মুনাফা দেওয়া হয় না।',
      'প্রজেক্টে লোকসান হলে শেয়ার অনুপাতে লোকসানের ভাগও বহন করতে হবে — এটি ইসলামী মুশারাকা নীতি।',
      'কোনো সুদ (রিবা) বা নিষিদ্ধ লেনদেন এই প্ল্যাটফর্মে নেই।',
    ]
  },
  referral: {
    icon: <Gift size={18} />,
