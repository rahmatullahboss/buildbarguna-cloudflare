...
const steps: OnboardingStep[] = [
  {
    ...
    body: 'এটি একটি শরিয়াহ-সম্মত profit-sharing প্ল্যাটফর্ম হিসেবে ডিজাইন করা হয়েছে। আপনি বরগুনার বিভিন্ন প্রজেক্টে শেয়ার কিনে মুনাফা উপার্জন করতে পারবেন, তবে চূড়ান্ত compliance প্রতিটি প্রজেক্টের screening-এর ওপর নির্ভর করে।',
    highlight: '✅ সুদমুক্ত কাঠামো | ✅ profit-sharing | ✅ governance review',
    action: null
  },
  {
