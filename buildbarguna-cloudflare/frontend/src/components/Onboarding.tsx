...
const steps = [
  {
    ...
    body: 'এটি একটি সম্পূর্ণ হালাল বিনিয়োগ প্ল্যাটফর্ম। আপনি বরগুনার নির্মাণ প্রজেক্টে শেয়ার কিনে মুনাফা উপার্জন করতে পারবেন।',
  ...
  },
  {
    ...
    body: 'প্রজেক্টসমূহ পেজে গিয়ে চলমান নির্মাণ প্রজেক্টগুলো দেখুন। প্রতিটি প্রজেক্টে শেয়ার মূল্য, মোট মূলধন ও বাকি শেয়ার দেখতে পাবেন।',
