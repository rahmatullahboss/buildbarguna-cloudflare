...
<body>
  <div class="certificate">
    ...
    <div class="footer">
      <div class="divider"></div>
      ${reg.verified_at ? `<div class="verification">Verified on: ${escapeHTML(verifiedDate)}</div>` : ''}
      <div class="issue-date">Issued on: ${escapeHTML(issueDate)}</div>
    </div>
...
<body>
  <div class="certificate">
    ...
    <div class="share-details">
      ...
      <div class="value">${escapeHTML(cert.share_quantity)} Share(s)</div>
      
      <div class="label">Total Investment:</div>
      <div class="value">BDT ${escapeHTML(amountTaka.toLocaleString('en-US'))} (${escapeHTML(cert.total_amount_paisa)} paisa)</div>
    ...
    <div class="footer">
      <div class="divider"></div>
      <div class="purchase-date">Purchase Date: ${escapeHTML(purchaseDate)}</div>
    </div>
