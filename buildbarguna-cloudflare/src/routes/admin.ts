...
const projectSchema = z.object({
  ...
  image_url: z.string().url().refine(val => val.toLowerCase().startsWith('http://') || val.toLowerCase().startsWith('https://'), { message: 'Must be an HTTP or HTTPS URL' }).optional().or(z.literal('')),
...
const rewardSchema = z.object({
  ...
  image_url: z.string().url().refine(val => val.toLowerCase().startsWith('http://') || val.toLowerCase().startsWith('https://'), { message: 'Must be an HTTP or HTTPS URL' }).optional()
})
