...
taskRoutes.get('/history', async (c) => {
  ...
  // ⚡ Bolt: Replaced Promise.all with db.batch() to eliminate per-query HTTP network overhead in D1.
  // Impact: Reduces 2 database network roundtrips down to 1, lowering endpoint latency.
