...
⚠️ **গুরুত্বপূর্ণ পরিবর্তন:**
এখন থেকে উইথড্র অনুমোদন করলে সাথে সাথে ব্যবহারকারীর অ্যাকাউন্ট থেকে টাকা কেটে নেওয়া হবে!

**নতুন প্রক্রিয়া:**

```
উইথড্র অনুমোদনের ফ্লো:
┌─────────────────────────────────────────────────────────────┐
│ ১. ব্যবহারকারী রিকোয়েস্ট করে                                │
│    └─ status = 'pending'                                    │
│                                                             │
│ ২. অ্যাডমিন অনুমোদন করে                                     │
│    └─ status = 'approved'                                   │
│    └─ ব্যালেন্স থেকে টাকা কাটা হয় (reserved)                │
│    └─ অডিট লগ তৈরি হয়                                      │
│                                                             │
│ ৩. অ্যাডমিন bKash-এ পাঠায়                                   │
│                                                             │
│ ৪. অ্যাডমিন কমপ্লিট করে                                     │
│    └─ status = 'completed'                                  │
│    └─ reserved → withdrawn-এ স্থানান্তর                      │
└─────────────────────────────────────────────────────────────┘
```
...
│ total_withdrawn  │ সম্পন্ন উইথড্র                        │
│ reserved         │ পেন্ডিং + অনুমোদিত (সংরক্ষিত)          │
└──────────────────┴────────────────────────────────────────┘

উপলব্ধ ব্যালেন্স = total_earned - total_withdrawn - reserved
```

**অডিট লগ:**

প্রতিটি লেনদেন ট্র্যাক করা হয়:
- `adjustment` - ব্যালেন্স ইনিশিয়ালাইজেশন
- `withdraw_reserve` - উইথড্র অনুমোদন (টাকা সংরক্ষিত)
- `withdraw_complete` - উইথড্র সম্পন্ন
- `withdraw_release` - উইথড্র প্রত্যাখ্যান (টাকা ফেরত)
...
⚠️ **গুরুত্বপূর্ণ:**
- **পেন্ডিং স্ট্যাটাসে প্রত্যাখ্যান:** শুধু রিকোয়েস্ট বাতিল হয়, কোনো টাকা কাটা হয়নি
- **অনুমোদিত স্ট্যাটাসে প্রত্যাখ্যান:** সংরক্ষিত টাকা স্বয়ংক্রিয়ভাবে ফেরত যায়
